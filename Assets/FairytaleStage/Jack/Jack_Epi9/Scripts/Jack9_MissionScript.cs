/*
 * - Name : Jack9_MissionScript.cs
 * - Writer : 김명현
 * - Content : 잭과콩나무 에피소드9 - 미션 스크립트(나레이션) 관리 스크립트
 * 
 *             -사용법-
...
public class Jack9_MissionScript : MonoBehaviour
{
    GameObject mg_EventScript;   //연결할 스크립트 오브젝트 선언

    //ms_ScriptText 에 문장을 입력해주세요.
    private string ms_ScriptText = "자루를 5번 터치하여 터뜨려주세요";
