 ...
 * - Writer : 김명현
 * - Content : 잭과콩나무 에피소드3 - 메인 스크립트(나레이션) 관리 스크립트
 * 
 *             -사용법-
...
public class Jack13_MainScript : MonoBehaviour{
    ...
    private string ms_ScriptText = "잭을 발견한 거인은 고함을 외쳤어요.@거인이 쿵쾅쿵쾅 잭의 뒤를 바짝 쫓았어요.@잭은 정신없이 콩나무 줄기를 타고 아래로 아래로 재빨리 내려갔어요.";
    private string[] msa_SplitText;
    private int mn_Sequence;

    void Start(){
        this.mg_MainScript = GameObject.Find("Jack13_Script");   //스크립트 오브젝트 연결
